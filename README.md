# EG Template Mod
EG Template Mod is the development core of all Drathonix/Vicious mods. You are welcome to use it yourself.

EG Template Mod uses [Stonecutter](https://stonecutter.kikugie.dev/stonecutter/introduction) for multiversioning and Architectury Loom for multi-modloader support. Architectury API is not required but is enabled by default. EG Template Mod by default provides support for:
...
1. Create a new project, use the Java template, not the Minecraft template. You will be practically deleting everything the MC template generates.
   ...
   3. Set the gradle DSL to kotlin. All EG Template Mod scripts are kotlin and will not work with groovy.
...
3. CTRL + SHIFT + R. Replace all instances of "eg_inventory_blur" with your planned modid. Replace all instances of "EG Template Mod" with your mod display name.
4. Rename the Mixin files from mixins.<loader>.eg_inventory_blur.json to mixins.\<loader\>.\<your modid\>.json. Rename the source root from your.group.eg_inventory_blur to <your group>.<your modid>
...
8. Once all the code is rid of EG Template Mod defaults set your active project to your preferred development version.

Finally, replace this README.md with your own and begin developing!

# Other Features
//TODO
# Projects using eg_inventory_blur:
